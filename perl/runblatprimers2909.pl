...
tie @primers, 'Tie::File', "/home/aled/Documents/primerdb/primers2909/ptrfblat.csv";
			...
			my @ss = split(/,/, $genes);
			 ...
			 #foreach primer select the genename and then query against the list of genes. if there is a match take the chrom number, start and stop coordinates (the gene list has the start finish point +/- 500bp)
					if($Gene eq $HGNCGenename){
						...
						$output = "/home/aled/Documents/primerdb/primers2909/blatoutput/$PrimerName.psl";
						print "output:$output\n";
						#filename is the primername.fa. this will create a fasta file containing  the primer name and sequence which will be used by BLAT
						$filename="$PrimerName.fa";
						$filepath = "/home/aled/Documents/primerdb/primers2909/fastas/$filename";
